...
export const CATEGORIES: Record<string, CategoryMeta> = {
  geography: {
    id: 'geography',
    label: { en: 'Geography', de: 'Geografie' },
    icon: '🌍',
  },
  history: {
    id: 'history',
    label: { en: 'History', de: 'Geschichte' },
    icon: '🏛️',
  },
  science: {
    id: 'science',
    label: { en: 'Science', de: 'Wissenschaft' },
    icon: '🔬',
  },
  ...
  technology: {
    id: 'technology',
    label: { en: 'Technology', de: 'Technik' },
    icon: '💻',
  },
  ...
  food: {
    id: 'food',
    label: { en: 'Food & Drink', de: 'Essen & Trinken' },
    icon: '🍽️',
  },
  space: { id: 'space', label: { en: 'Space', de: 'Weltall' }, icon: '🚀' },
  mythology: {
    id: 'mythology',
    label: { en: 'Mythology', de: 'Mythologie' },
    icon: '🐉',
  },
  ...
  popculture: {
    id: 'popculture',
    label: { en: 'Pop Culture', de: 'Popkultur' },
    icon: '🌟',
  },
  videogames: {
    id: 'videogames',
    label: { en: 'Video Games', de: 'Videospiele' },
    icon: '🎮',
  },
};
