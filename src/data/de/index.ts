...
import { QUESTIONS as popculture } from './popculture.js';
...
import { QUESTIONS as videogames } from './videogames.js';

export const BY_CATEGORY: Record<string, readonly QuizQuestion[]> = { arts, film, food, geography, history, language, math, music, mythology, nature, popculture, science, space, sports, technology, videogames };
export const QUESTIONS: readonly QuizQuestion[] = [...arts, ...film, ...food, ...geography, ...history, ...language, ...math, ...music, ...mythology, ...nature, ...popculture, ...science, ...space, ...sports, ...technology, ...videogames];
